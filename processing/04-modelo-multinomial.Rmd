...
mp1 <- elsoc_salud_modelo %>%
  multinom(trayectoria_gmm.5agrup ~ m0_sexo_w01 + m0_edad_w01 + log_ing + trayectoria_deuda + trayectoria_ocup2 + trayectoria_apoyo_social,
           data = ., weights = ponderador02_w01) 

mp2 <- elsoc_salud_modelo %>%
  multinom(trayectoria_gmm.5agrup ~ m0_sexo_w01 + m0_edad_w01 + log_ing + trayectoria_deuda + trayectoria_ocup2 + trayectoria_apoyo_social + trayectoria_activ_fisica + proyecto_vida,
           data = ., weights = ponderador02_w01) 

mp3 <- elsoc_salud_modelo %>%
  multinom(trayectoria_gmm.5agrup ~ m0_sexo_w01 + m0_edad_w01 + log_ing + trayectoria_deuda + trayectoria_ocup2 + trayectoria_activ_fisica + trayectoria_apoyo_social + proyecto_vida + extraversion + agreeableness + conscientiousness + neuroticism + openness,
           data = ., weights = ponderador02_w01) 
