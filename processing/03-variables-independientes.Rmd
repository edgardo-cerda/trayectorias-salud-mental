...
m1 <- elsoc_salud_modelo %>%
  multinom(trayectoria_gmm.4lin ~ m0_sexo_w01 + m0_edad_w01 + quintil_w01 + sobrecarga_deuda_w01 + sobrecarga_deuda_w03 + sobrecarga_deuda_w05 + ocup_w01,
           data = .) 

m2 <- elsoc_salud_modelo %>%
  multinom(trayectoria_gmm.4lin ~ m0_sexo_w01 + m0_edad_w01 + log_ing + sobrecarga_deuda_w03 + sobrecarga_deuda_w05 + ocup_w01,
           data = .) 

m3 <- elsoc_salud_modelo %>%
  multinom(trayectoria_gmm.4lin ~ m0_sexo_w01 + m0_edad_w01 + factor(m16_w01 %in% 1:2) + sobrecarga_deuda_w03 + sobrecarga_deuda_w05 + ocup_w01,
           data = .) 
