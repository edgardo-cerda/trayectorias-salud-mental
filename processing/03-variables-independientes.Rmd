...
elsoc_salud_modelo <- elsoc_salud %>% 
  ...
  mutate(
    ...
    sobrecarga_deuda_w01 = factor(m43_w01 == 5),
    sobrecarga_deuda_w03 = factor(m43_w03 == 5),
    sobrecarga_deuda_w05 = factor(m43_w05 == 5))
...
m1 <- elsoc_salud_modelo %>%
  multinom(trayectoria_gmm.4lin ~ sexo + m0_edad_w01 + quintil_w01 + sobrecarga_deuda_w01 + sobrecarga_deuda_w03 + sobrecarga_deuda_w05 + ocup_w01,
           data = .) 

m2 <- elsoc_salud_modelo %>%
  multinom(trayectoria_gmm.4lin ~ sexo + m0_edad_w01 + log_ing + sobrecarga_deuda_w03 + sobrecarga_deuda_w05 + ocup_w01,
           data = .) 

m3 <- elsoc_salud_modelo %>%
  multinom(trayectoria_gmm.4lin ~ sexo + m0_edad_w01 + factor(m16_w01 %in% 1:2) + sobrecarga_deuda_w03 + sobrecarga_deuda_w05 + ocup_w01,
           data = .) 
