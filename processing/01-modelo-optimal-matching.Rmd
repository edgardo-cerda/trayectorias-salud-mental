...
```{r}
TraMineR::seqIplot(seq.depr4, group = stats::cutree(ward.depr4, k = 3),
                   border = NA, with.legend = "top",
                   space = 0)

TraMineR::seqIplot(seq.depr4, group = stats::cutree(ward.depr4, k = 4),
                   border = NA, with.legend = "top",
                   space = 0)

TraMineR::seqIplot(seq.depr4, group = stats::cutree(ward.depr4, k = 5),
                   border = NA, with.legend = "top",
                   space = 0)

TraMineR::seqIplot(seq.depr4, group = stats::cutree(ward.depr4, k = 6),
                   border = NA, with.legend = "top",
                   space = 0)
...
```{r}
TraMineR::seqIplot(seq.depr2, group = stats::cutree(ward.depr2, k = 3),
                   border = NA, with.legend = "top",
                   space = 0)

TraMineR::seqIplot(seq.depr2, group = stats::cutree(ward.depr2, k = 4),
                   border = NA, with.legend = "top",
                   space = 0)

TraMineR::seqIplot(seq.depr2, group = stats::cutree(ward.depr2, k = 5),
                   border = NA, with.legend = "top",
                   space = 0)

TraMineR::seqIplot(seq.depr2, group = stats::cutree(ward.depr2, k = 6),
                   border = NA, with.legend = "top",
                   space = 0)
